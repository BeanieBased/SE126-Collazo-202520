...
for i in range(0, len(names)):
    print(f"{names[i]:12} {riders[i]:30} {num[i]:3} {color1[i]:8} {color2[i]}")
print("-" * 75)
...
#we mut also ensure the collection we search through is populated with UNIQUE values

#bubble sort algorithm - a loop inside a loop
...
if search.lower() == names[mid].lower():
    ...
    print(f"{names[mid]:12} {riders[mid]:30} {num[mid]:3} {color1[mid]:8} {color2[mid]}\n")
else:
...
print(letters[0][0])        #first value in first line of 2D letters
