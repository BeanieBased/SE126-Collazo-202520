...
#Program Prompt: In the W4D2 demo, we will review utilizing sequential search for simple singular and multi returns.
#We will then create and write data to a text file using Python.
...
#creating empty lists - 1 for each field
dragons = []        #field0
riders = []         #field1
count = []          #field2 *
color1 = []         #field3
...
#SEARCH FOR A SPECIFIC COLOR SET
...
file = open('textFiles/targs.csv', 'w')
