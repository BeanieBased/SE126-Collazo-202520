...
with open ("textFiles/library_books.csv") as csvfile:
...
if not found:
    ...
    print(f"{'LIB#':5}  {'TITLE':25}  {'AUTHOR':15}  {'GENRE':20}  {'PAGES':5}")
    print("--------------------------------------------------------------------------------")
    for i in range(0, len(found)): #foud is a LIST of location indexes
...
while min < max and searchNum != libraryNums[mid]:
    ...
    #searchNum != libaryNums[mid] --> what we are looking for is not in the mid position
